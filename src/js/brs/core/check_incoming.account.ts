        ...
        function (response: GetAccountResponse) {
            ...
            if (response.errorCode) {
                ...
                const showAssetDifference =
                    ...
                    (BRS.blocks.length > 0 &&
                        BRS.blockchainStatus &&
                        BRS.blockchainStatus.time - BRS.blocks[0].timestamp < 60 * 60 * 24 * 7)
            ...
            if (firstRun) {
                ...
                $('#account_balance, #account_committed_balance, #account_nr_assets, #account_balance_sendmoney').removeClass(
                    'loading_dots',
                )
            }
